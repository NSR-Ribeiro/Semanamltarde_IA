...
#FIXME: EAR (usando distânicia euclidiana)
    ...
    while cap.isOpened():
        ...
        try:     
            for face_landmarks in saida_facemesh.multi_face_landmarks:
                ...
                face_landmarks,
                mp_face_mesh.FACEMESH_CONTOURS,landmark_drawing_spec=mp_drawing.DrawingSpec(color=(255,102,102),thickness=1,circle_radius=1),
                connection_drawing_spec = mp_drawing.DrawingSpec(color=(102,104,0),thickness=1,circle_radius=1))
                ...
                cv2.putText(frame, f"Tempo: {round(tempo, 3)}", (1, 80),
                                        ...
                                        0.9, (255, 255, 255), 2)
                # identificando solol~encia
                if tempo>=1.5:
                    cv2.rectangle(frame, (30, 400),(610,452), (109, 233, 219), -1)
                    cv2.putText(frame, f"Muito tempo com olhos fechados", (80, 435), cv2.PONT_HERSHEY_DUPLEX, 0.85, (58,58,55), 1)
